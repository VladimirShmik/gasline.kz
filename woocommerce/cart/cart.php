...
<form class="woocommerce-cart-form" action="<?php echo esc_url(wc_get_cart_url()); ?>" method="post">
    ...
    <div class="shop_table shop_table_responsive cart woocommerce-cart-form__contents product-table" cellspacing="0">
        <div class="heading-wrapper">
            <div class="product-heading">
                <div class="product-remove">
                    <span class="screen-reader-text"><?php esc_html_e('Remove item', 'woocommerce'); ?></span></div>
                ...
                <div class="product-subtotal">Итого</div>
            </div>
        </div>
        <div class="product-content">
            ...
            foreach (WC()->cart->get_cart() as $cart_item_key => $cart_item) {
                ...
                if ($_product && $_product->exists() && $cart_item['quantity'] > 0 && apply_filters('woocommerce_cart_item_visible', true, $cart_item, $cart_item_key)) {
                    ...
                    ?>
                    <div class="woocommerce-cart-form__cart-item item-product <?php echo esc_attr(apply_filters('woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key)); ?>">
